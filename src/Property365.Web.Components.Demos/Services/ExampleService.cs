...
namespace Property365.Web.Components.Demos
{
    public class ExampleService
    {
        ...
        {
            Name = "Get Started",
            Title = "How to get started with the Property365 Web Components",
            Path = "/get-started",
            Icon = "&#xe037"
        },
        new Example
        {
            Name = "Support",
            Title = "How to get support for the Property365 Web Components",
            Path = "/support",
            Icon = "&#xe94c"
        },
        ...
        public string TitleFor(Example example)
        {
            ...
            {
                return example.Title ?? $"Blazor {example.Name} | a free UI component by Realty365";
            }

            return "60+ controls by Realty365";
        }

        public string DescriptionFor(Example example)
        {
            return example?.Description ?? "The Realty365 Blazor component library provides more than 50 UI controls for building rich ASP.NET Core web applications.";
        }
    }
}