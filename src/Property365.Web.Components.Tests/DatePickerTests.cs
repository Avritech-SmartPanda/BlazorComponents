...
namespace Property365.Web.Components.Tests
{
    public class DatePickerTests
    {
        ...
        public void DatePicker_Renders_CssClass()
        {
            ...
            var component = ctx.RenderComponent<Property365DatePicker<DateTime>>();
        ...
        public void DatePicker_Renders_AllowClearParameter()
        {
            ...
            Assert.Contains(@$"<i class=""dropdown-clear-icon rzi rzi-times""", component.Markup);
        }
        ...
        public void DatePicker_Raises_ValueChangedEvent_Returns_PreviousDateOnInputOnDisabledDates()
        {
            ...
            ctx.JSInterop.Setup<string>("Property365.getInputValue", invocation => true).SetResult(previousDay.ToShortDateString());
            inputElement.Change(previousDay.AddDays(-1));

            // try to enter disabled date
            ctx.JSInterop.Setup<string>("Property365.getInputValue", invocation => true).SetResult(DateTime.Today.ToShortDateString());
        ...
        public void DatePicker_Respects_DateTimeMaxValue()
        {
            ...
            var component = ctx.RenderComponent<Property365DatePicker<DateTime>>(parameters =>
            {
