...
namespace Property365.Web.Components.Tests
{
    public class NumericTests
    {
        ...
        public void Numeric_Renders_CssClasses()
        {
            ...
            var component = ctx.RenderComponent<Property365Numeric<double>>();
        ...
        public void Numeric_UpDown_NotRenderedIfHidden()
        {
            ...
            var component = ctx.RenderComponent<Property365Numeric<double>>(ComponentParameter.CreateParameter(nameof(Property365Numeric<double>.ShowUpDown), false));
        ...
        public void Numeric_Formatted()
        {
            ...
            var component = ctx.RenderComponent<Property365Numeric<double>>(
                ComponentParameter.CreateParameter(nameof(Property365Numeric<double>.Format), format),
                ComponentParameter.CreateParameter(nameof(Property365Numeric<double>.Value), valueToTest)
            );
