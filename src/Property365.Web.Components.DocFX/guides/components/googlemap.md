...
<h3>Show marker for Madrid 
    <Property365CheckBox @bind-Value=@showMadridMarker />
</h3>
<Property365GoogleMap style="height: 400px" Zoom=@zoom Center=@(new GoogleMapPosition() { Lat = 42.6977, Lng = 23.3219 }) MapClick=@OnMapClick MarkerClick=@OnMarkerClick>
    <Markers>
        ...
        @if (showMadridMarker)
        { 
            <Property365GoogleMapMarker Title="Madrid " Label="Madrid" Position=@(new GoogleMapPosition() { Lat = 40.4168, Lng = -3.7038 }) />
        }
    </Markers>
