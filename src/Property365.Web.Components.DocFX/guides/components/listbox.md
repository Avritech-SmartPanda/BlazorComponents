...
```
<Property365ListBox TValue="string" Data=@(customers.Select(c => c.CompanyName).Distinct()) Change="@OnChange" />
...
```
<Property365ListBox TValue="string" Data=@customers TextProperty="CompanyName" ValueProperty="CustomerID" Change="@OnChange" />
...
```
<Property365ListBox TValue="string" Data=@customers TextProperty="CompanyName" ValueProperty="CustomerID" LoadData=@LoadData AllowFiltering="true" />
...
```
<Property365ListBox TValue="string" AllowVirtualization="true" AllowFiltering="true" Data=@customers TextProperty="CompanyName" ValueProperty="CustomerID" />
...
```
<Property365ListBox TValue="string" AllowVirtualization="true" LoadData=@LoadDataVirtualization AllowFiltering="true" Count="@count"
...
```
<Property365ListBox @bind-Value=@multipleValues Multiple="true" 
