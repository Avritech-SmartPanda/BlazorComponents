...
namespace Property365.Web.Components
{
    ...
    /// <example>
    /// <code>
    /// &lt;Property365FormTemplate TItem="Model" Data=@model&gt;
    ...
    /// </code>
    /// </example>
    public class Property365FormTemplate<TItem> : Property365Component, IProperty365Form
    {
        /// <summary>
        ...
        /// <example>
        /// <code>
        /// &lt;Property365FormTemplate TItem="Model" OnValidSubmit=@OnSubmit Data=@model&gt;
        ///   &lt;Property365TextBox style="display: block" Name="Email" @bind-Value=@model.Email /&gt;
        ///   &lt;Property365RequiredValidator Component="Email" Text="Email is required" Style="position: absolute" /&gt;
        /// &lt;/Property365FormTemplate&gt;
        /// @code {
        ...
        /// </example>
        [Parameter]
        public EventCallback<TItem> OnValidSubmit { get; set; }
        ...
        /// <example>
        /// <code>
        /// &lt;Property365FormTemplate TItem="Model" InvalidSubmit=@OnInvalidSubmit Data=@model&gt;
        ///   &lt;Property365TextBox style="display: block" Name="Email" @bind-Value=@model.Email /&gt;
        ///   &lt;Property365RequiredValidator Component="Email" Text="Email is required" Style="position: absolute" /&gt;
        /// &lt;/Property365FormTemplate&gt;
        /// @code {
        ...
        /// <example>
        /// <code>
        /// &lt;Property365FormTemplate TItem="Model" Method="post" Action="/register" Data=@model&gt;
        ///   &lt;Property365TextBox style="display: block" Name="Email" @bind-Value=@model.Email /&gt;
        ///   &lt;Property365RequiredValidator Component="Email" Text="Email is required" Style="position: absolute" /&gt;
        /// &lt;/Property365FormTemplate&gt;
        /// </code>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Property365FormTemplate{TItem}"/> class.
        /// </summary>
        public Property365FormTemplate()
        {
