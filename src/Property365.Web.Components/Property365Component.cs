...
{
    /// <summary>
    ///   Base class of Property365 Web Components.
    /// </summary>
    public class Property365Component : ComponentBase, IDisposable
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="Property365Component"/> is visible. Invisible components are not rendered.
        /// </summary>
        ...
        private DotNetObjectReference<Property365Component> reference;

        /// <summary>
        /// Gets the reference for the current component.
        /// </summary>
        /// <value>The reference.</value>
        protected DotNetObjectReference<Property365Component> Reference
        {
            get
            {
                if (reference == null)
        ...
        protected override async Task OnAfterRenderAsync(bool firstRender)
        {
            ...
            if (firstRender || visibleChanged)
            {
                ...
                if (Visible)
                {
                    ...
                    {
                        await JSRuntime.InvokeVoidAsync("Property365Components.addContextMenu", UniqueID, Reference);
                    }

                    if (MouseEnter.HasDelegate)
                    {
                        await JSRuntime.InvokeVoidAsync("Property365Components.addMouseEnter", UniqueID, Reference);
                    }

                    if (MouseLeave.HasDelegate)
                    {
                        await JSRuntime.InvokeVoidAsync("Property365Components.addMouseLeave", UniqueID, Reference);
                    }
                }
            }
        }
        ...
        [JSInvokable("Property365Component.RaiseContextMenu")]
        ...
        /// </summary>
        [JSInvokable("Property365Component.RaiseMouseEnter")]
        ...
        /// </summary>
        [JSInvokable("Property365Component.RaiseMouseLeave")]
        ...
        public virtual void Dispose()
        {
            ...
            if (IsJSRuntimeAvailable)
            {
                if (ContextMenu.HasDelegate)
                {
                    JSRuntime.InvokeVoidAsync("Property365Components.removeContextMenu", UniqueID);
                }

                if (MouseEnter.HasDelegate)
                {
                    JSRuntime.InvokeVoidAsync("Property365Components.removeMouseEnter", UniqueID);
                }

                if (MouseLeave.HasDelegate)
                {
                    JSRuntime.InvokeVoidAsync("Property365Components.removeMouseLeave", UniqueID);
                }
            }
        }
