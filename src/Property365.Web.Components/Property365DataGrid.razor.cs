...
{
    /// <summary>
    /// Property365DataGrid component.
    /// </summary>
    /// <typeparam name="TItem">The type of the DataGrid data item.</typeparam>
    /// <example>
    /// <code>
    /// &lt;Property365DataGrid @data=@orders TItem="Order" AllowSorting="true" AllowPaging="true" AllowFiltering="true"&gt;
    ///     &lt;Columns&gt;
    ///         &lt;Property365DataGridColumn TItem="Order" Property="OrderId" Title="OrderId" /&gt;
    ///         &lt;Property365DataGridColumn TItem="Order" Property="OrderDate" Title="OrderDate" /&gt;
    ///     &lt;/Columns&gt;
    /// &lt;/Property365DataGrid&gt;
    /// </code>
    /// </example>
    public partial class Property365DataGrid<TItem> : PagedDataBoundComponent<TItem>
    {
#if NET5
...
#endif
        RenderFragment DrawRows(IList<Property365DataGridColumn<TItem>> visibleColumns)
        {
                ...
                if (AllowVirtualization)
                {
                    if(AllowGrouping && Groups.Any() && !LoadData.HasDelegate)
                    {
                        ...
                        builder.AddAttribute(2, "ChildContent", (RenderFragment<GroupResult>)((context) =>
                        {
                            ...
                            {
                                b.OpenComponent(3, typeof(Property365DataGridGroupRow<TItem>));
                    ...
                    else
                    {
                        ...
                        builder.AddAttribute(2, "ChildContent", (RenderFragment<TItem>)((context) =>
                        {
                            return (RenderFragment)((b) =>
                            {
                                b.OpenComponent<Property365DataGridRow<TItem>>(3);
                                b.AddAttribute(4, "Columns", visibleColumns);
                                b.AddAttribute(5, "Grid", this);
                                ...
                                {
                                    b.AddAttribute(10, nameof(Property365DataGridRow<TItem>.EditContext), editContexts[context]);
                                }
        ...
        internal void DrawGroupOrDataRows(Microsoft.AspNetCore.Components.Rendering.RenderTreeBuilder builder, IList<Property365DataGridColumn<TItem>> visibleColumns)
        {
            if (Groups.Any())
            {
                foreach (var group in GroupedPagedView)
                {
                    builder.OpenComponent(0, typeof(Property365DataGridGroupRow<TItem>));
            ...
            else
            {
                ...
                {
                    builder.OpenComponent<Property365DataGridRow<TItem>>(0);
                    builder.AddAttribute(1, "Columns", visibleColumns);
                    ...
                    {
                        builder.AddAttribute(7, nameof(Property365DataGridRow<TItem>.EditContext), editContexts[item]);
                    }
        ...
        internal string getFrozenColumnClass(Property365DataGridColumn<TItem> column, IList<Property365DataGridColumn<TItem>> visibleColumns)
        {
        ...
        protected string DateFilterOperatorStyle(Property365DataGridColumn<TItem> column, FilterOperator value)
        {
        ...
        /// <param name="column">The column.</param>
        protected void OnFilterKeyPress(EventArgs args, Property365DataGridColumn<TItem> column)
        {
            Debounce(() => DebounceFilter(column), FilterDelay);
        }

        async Task DebounceFilter(Property365DataGridColumn<TItem> column)
        {
            var inputValue = await JSRuntime.InvokeAsync<string>("Property365Components.getInputValue", getFilterInputId(column));
        ...
        protected void ApplyDateFilterByFilterOperator(Property365DataGridColumn<TItem> column, FilterOperator filterOperator)
        {
        ...
        private List<Property365DataGridColumn<TItem>> columns = new List<Property365DataGridColumn<TItem>>();
        internal readonly List<Property365DataGridColumn<TItem>> childColumns = new List<Property365DataGridColumn<TItem>>();
        private List<Property365DataGridColumn<TItem>> allColumns = new List<Property365DataGridColumn<TItem>>();
        private List<Property365DataGridColumn<TItem>> allPickableColumns = new List<Property365DataGridColumn<TItem>>();
        ...
        internal void AddColumn(Property365DataGridColumn<TItem> column)
        {
        ...
        internal void UpdatePickableColumn(Property365DataGridColumn<TItem> column, bool visible)
        {
            if (selectedColumns == null)
                return;

            var columnsList = (IList<Property365DataGridColumn<TItem>>)selectedColumns;
            if (visible)
            {
        ...
        internal void RemoveColumn(Property365DataGridColumn<TItem> column)
        {
        ...
        void ToggleColumns()
        {
            ...
            {
                c.SetVisible(((IEnumerable<object>)selectedColumns).Cast<Property365DataGridColumn<TItem>>().Contains(c));
            }
        }

        string getFilterInputId(Property365DataGridColumn<TItem> column)
        {
            return string.Join("", $"{UniqueID}".Split('.')) + column.GetFilterProperty();
        }

        internal string getFilterDateFormat(Property365DataGridColumn<TItem> column)
        {
        ...
        internal RenderFragment DrawNumericFilter(Property365DataGridColumn<TItem> column, bool force = true, bool isFirst = true)
        {
            return new RenderFragment(builder =>
            {
                ...
                var numericType = typeof(Property365Numeric<>).MakeGenericType(type);
        ...
        protected void OnFilter(ChangeEventArgs args, Property365DataGridColumn<TItem> column, bool force = false, bool isFirst = true)
        {
        ...
        public IList<Property365DataGridColumn<TItem>> ColumnsCollection
        {
            get
            {
                return columns;
        ...
        internal void OnSort(EventArgs args, Property365DataGridColumn<TItem> column)
        {
        ...
        internal async Task ClearFilter(Property365DataGridColumn<TItem> column, bool closePopup = false)
        {
            if (closePopup)
            {
                await JSRuntime.InvokeVoidAsync("Property365Components.closePopup", $"{PopupID}{column.GetFilterProperty()}");
            }
        ...
        internal async Task ApplyFilter(Property365DataGridColumn<TItem> column, bool closePopup = false)
        {
            if (closePopup)
            {
                await JSRuntime.InvokeVoidAsync("Property365Components.closePopup", $"{PopupID}{column.GetFilterProperty()}");
        ...
        internal IReadOnlyDictionary<string, object> CellAttributes(TItem item, Property365DataGridColumn<TItem> column)
        {
            var args = new Property365.Web.Components.DataGridCellRenderEventArgs<TItem>() { Data = item, Column = column };
        ...
        internal IReadOnlyDictionary<string, object> HeaderCellAttributes(Property365DataGridColumn<TItem> column)
        {
            var args = new Property365.Web.Components.DataGridCellRenderEventArgs<TItem>() { Column = column };
        ...
        internal IReadOnlyDictionary<string, object> FooterCellAttributes(Property365DataGridColumn<TItem> column)
        {
            var args = new Property365.Web.Components.DataGridCellRenderEventArgs<TItem>() { Column = column };
        ...
        {
            await JSRuntime.InvokeVoidAsync("Property365Components.startColumnResize", getColumnResizerId(columnIndex), Reference, columnIndex, args.ClientX);
        }
        ...
        internal async Task StartColumnReorder(MouseEventArgs args, int columnIndex)
        {
            ...
            await JSRuntime.InvokeVoidAsync("Property365Components.startColumnReorder", getColumnResizerId(columnIndex));
        }
        ...
        /// <param name="value">The value.</param>
        [JSInvokable("Property365Grid.OnColumnResized")]
        ...
        async Task InvokeLoadData(int start, int top)
        {
            ...
            if (LoadData.HasDelegate)
            {
                ...
                await LoadData.InvokeAsync(new Property365.Web.Components.LoadDataArgs()
                {
                    Skip = start,
                    Top = top,
                    OrderBy = orderBy,
        ...
        internal Dictionary<Property365DataGridGroupRow<TItem>, bool> collapsedGroupItems = new Dictionary<Property365DataGridGroupRow<TItem>, bool>();

        internal string ExpandedGroupItemStyle(Property365DataGridGroupRow<TItem> item, bool? expandedOnLoad)
        {
        ...
        internal bool IsGroupItemExpanded(Property365DataGridGroupRow<TItem> item)
        {
            return !collapsedGroupItems.Keys.Contains(item);
        }

        internal async System.Threading.Tasks.Task ExpandGroupItem(Property365DataGridGroupRow<TItem> item, bool? expandedOnLoad)
        {
        ...
        internal Tuple<Property365.Web.Components.RowRenderEventArgs<TItem>, IReadOnlyDictionary<string, object>> RowAttributes(TItem item)
        {
            var args = new Property365.Web.Components.RowRenderEventArgs<TItem>() { Data = item, Expandable = Template != null };
            ...
            return new Tuple<Property365.Web.Components.RowRenderEventArgs<TItem>, IReadOnlyDictionary<string, object>>(args, new System.Collections.ObjectModel.ReadOnlyDictionary<string, object>(args.Attributes));
        }

        internal Tuple<GroupRowRenderEventArgs, IReadOnlyDictionary<string, object>> GroupRowAttributes(Property365DataGridGroupRow<TItem> item)
        {
            var args = new Property365.Web.Components.GroupRowRenderEventArgs() { Group = item.Group, FirstRender = firstRender };
        ...
        protected override async Task OnAfterRenderAsync(bool firstRender)
        {
            ...
            if (Visible)
            {
                var args = new Property365.Web.Components.DataGridRenderEventArgs<TItem>() { Grid = this, FirstRender = firstRender };
        ...
        internal void SetColumnSortOrder(Property365DataGridColumn<TItem> column)
        {
        ...
        List<Property365DataGridColumn<TItem>> groupedColumns = new List<Property365DataGridColumn<TItem>>();
        /// <summary>
        ...
        public override void Dispose()
        {
            ...
            if (IsJSRuntimeAvailable)
            {
                ...
                {
                    JSRuntime.InvokeVoidAsync("Property365Components.destroyPopup", $"{PopupID}{column.GetFilterProperty()}");
                }
            }
        }
