...
namespace Property365.Web.Components
{
    ...
    /// Should be added as scoped service in the application services and Property365Dialog should be added in application main layout.
    /// </summary>
    /// <example>
    /// <code>
    ...
    public class DialogService : IDisposable
    {
        ...
        public async Task<bool?> Confirm(string message = "Confirm?", string title = "Confirm", ConfirmOptions options = null)
        {
            ...
            await JSRuntime.InvokeAsync<string>("Property365Components.openDialog", dialogOptions, Reference);
            ...
            return await OpenAsync(title, ds =>
            {
                RenderFragment content = b =>
                {
                    ...
                    b.OpenElement(i++, "div");
                    b.AddAttribute(i++, "class", "flex flex-row");
                    b.OpenElement(i++, "div");
                    b.AddAttribute(i++, "class", "w-full");

                    b.OpenComponent<Property365Button>(i++);
