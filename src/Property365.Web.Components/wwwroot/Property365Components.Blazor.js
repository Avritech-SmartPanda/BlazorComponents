...
window.Property365Components = {
  ...
  addContextMenu: function (id, ref) {
     ...
     if (el) {
        var handler = function (e) {
            e.stopPropagation();
            e.preventDefault(); 
            ref.invokeMethodAsync('Property365Components.RaiseContextMenu',
                {
                    ClientX: e.clientX,
                    ClientY: e.clientY,
                    ScreenX: e.screenX,
       ...
       Property365Components[id + 'contextmenu'] = handler;
  ...
  addMouseEnter: function (id, ref) {
     ...
     if (el) {
        var handler = function (e) {
            ref.invokeMethodAsync('Property365Components.RaiseMouseEnter');
        };
        Property365Components[id + 'mouseenter'] = handler;
  ...
  addMouseLeave: function (id, ref) {
     ...
     if (el) {
        var handler = function (e) {
            ref.invokeMethodAsync('Property365Components.RaiseMouseLeave');;
        };
       Property365Components[id + 'mouseleave'] = handler;
        el.addEventListener('mouseleave', handler, false);
     }
  },
  removeContextMenu: function (id) {
      var el = document.getElementById(id);
      if (el &&Property365Components[id + 'contextmenu']) {
          el.removeEventListener('contextmenu',Property365Components[id + 'contextmenu']);
      }
  },
  removeMouseEnter: function (id) {
      var el = document.getElementById(id);
      if (el &&Property365Components[id + 'mouseenter']) {
          el.removeEventListener('mouseenter',Property365Components[id + 'mouseenter']);
      }
  },
  removeMouseLeave: function (id) {
      var el = document.getElementById(id);
      if (el &&Property365Components[id + 'mouseleave']) {
          el.removeEventListener('mouseleave',Property365Components[id + 'mouseleave']);
      }
  },
  ...
  createMap: function (wrapper, ref, id, apiKey, zoom, center, markers) {
    var api = function () {
      ...
      return new Promise(function (resolve, reject) {
        ...
        Property365Components.loadGoogleMaps(defaultView, apiKey, resolve, reject);
      });
    };

    api().then(function (google) {
     Property365Components[id] = ref;
     Property365Components[id].google = google;

     Property365Components[id].instance = new google.maps.Map(wrapper, {
        center: center,
        zoom: zoom
      });

     Property365Components[id].instance.addListener('click', function (e) {
       Property365Components[id].invokeMethodAsync('Property365GoogleMap.OnMapClick', {
          Position: {Lat: e.latLng.lat(), Lng: e.latLng.lng()}
        });
      });

      Property365Components.updateMap(id, zoom, center, markers);
    });
  },
  updateMap: function (id, zoom, center, markers) {
    if (Property365[id] &&Property365Components[id].instance) {
      if (Property365[id].instance.markers &&Property365Components[id].instance.markers.length) {
        for (var i = 0; i <Property365Components[id].instance.markers.length; i++) {
         Property365Components[id].instance.markers[i].setMap(null);
        }
      }

     Property365Components[id].instance.markers = [];
      ...
      markers.forEach(function (m) {
        ...
        marker.addListener('click', function (e) {
         Property365Components[id].invokeMethodAsync('Property365GoogleMap.OnMarkerClick', {
            Title: marker.title,
            Label: marker.label,
        ...
        marker.setMap(Property365[id].instance);

       Property365Components[id].instance.markers.push(marker);
      });

     Property365Components[id].instance.setZoom(zoom);

     Property365Components[id].instance.setCenter(center);
    }
  },
  destroyMap: function (id) {
    if (Property365[id].instance) {
      deleteProperty365Components[id].instance;
    }
  },
  createSlider: function (
   ...
   Property365Components[id] = {};
   Property365Components[id].mouseMoveHandler = function (e) {
      ...
      if (
        ...
        slider.invokeMethodAsync(
          'Property365Slider.OnValueChange',
          newValue,
          !!slider.isMin
        );
      }
   ...
   Property365Components[id].mouseDownHandler = function (e) {
   ...
   Property365Components[id].mouseUpHandler = function (e) {
      slider.canChange = false;
    };

    document.addEventListener('mousemove',Property365Components[id].mouseMoveHandler);
    document.addEventListener('touchmove',Property365Components[id].mouseMoveHandler, {
      passive: false, capture: true
    });

    document.addEventListener('mouseup',Property365Components[id].mouseUpHandler);
    document.addEventListener('touchend',Property365Components[id].mouseUpHandler, {
      passive: true
    });

    parent.addEventListener('mousedown',Property365Components[id].mouseDownHandler);
    parent.addEventListener('touchstart',Property365Components[id].mouseDownHandler, {
      passive: true
    });
  },
  destroySlider: function (id, parent) {
    if (!Property365[id]) return;

    if (Property365[id].mouseMoveHandler) {
      document.removeEventListener('mousemove',Property365Components[id].mouseMoveHandler);
      document.removeEventListener('touchmove',Property365Components[id].mouseMoveHandler);
      deleteProperty365Components[id].mouseMoveHandler;
    }
    if (Property365[id].mouseUpHandler) {
      document.removeEventListener('mouseup',Property365Components[id].mouseUpHandler);
      document.removeEventListener('touchend',Property365Components[id].mouseUpHandler);
      deleteProperty365Components[id].mouseUpHandler;
    }
    if (Property365[id].mouseDownHandler) {
        parent.removeEventListener('mousedown',Property365Components[id].mouseDownHandler);
      parent.removeEventListener('touchstart',Property365Components[id].mouseDownHandler);
      deleteProperty365Components[id].mouseDownHandler;
    }

   Property365Components[id] = null;
  },
  ...
  uploadInputChange: function (e, url, auto, multiple, clear, parameterName) {
    if (auto) {
        Property365Components.upload(e.target, url, multiple, clear, parameterName);
        e.target.value = '';
    } else {
        Property365Components.uploadChange(e.target);
    }
},
uploads: function (uploadComponent, id) {
  if (!Property365Components.uploadComponents) {
    Property365Components.uploadComponents = {};
  }
  Property365Components.uploadComponents[id] = uploadComponent;
},
uploadChange: function (fileInput) {
  ...
  var uploadComponent =
    Property365Components.uploadComponents && Property365Components.uploadComponents[fileInput.id];
  if (uploadComponent) {
    ...
    uploadComponent.invokeMethodAsync('Property365Upload.OnChange', files);
  }
...
removeFileFromUpload: function (fileInput, name) {
  var uploadComponent = Property365Components.uploadComponents && Property365Components.uploadComponents[fileInput.id];
...
upload: function (fileInput, url, multiple, clear, parameterName) {
    ...
    if (xhr.readyState === XMLHttpRequest.DONE) {
      ...
      if (uploadComponent) {
        if (status === 0 || (status >= 200 && status < 400)) {
          uploadComponent.invokeMethodAsync(
            'Property365Upload.OnComplete',
              xhr.responseText,
              cancelled
          );
        } else {
          uploadComponent.invokeMethodAsync(
            'Property365Upload.OnError',
            xhr.responseText
          );
        }
      }
  ...
  getCulture: function () {
    var cultureCookie = Property365Components.getCookie('.AspNetCore.Culture');
  ...
  openContextMenu: function (x,y,id) {
    Property365Components.closePopup(id);

    Property365Components.openPopup(null, id, false, null, x, y);
  },
  openTooltip: function (target, id, duration, position) {
    Property365Components.closePopup(id);

    if (Property365Components[id + 'duration']) {
      clearTimeout(Property365Components[id + 'duration']);
    }

    Property365Components.openPopup(target, id, false, position);

    if (duration) {
     Property365Components[id + 'duration'] = setTimeout(Property365Components.closePopup, duration, id);
    }
  },
  ...
  openPopup: function (parent, id, syncWidth, position, x, y, instance, callback) {
    ...
    Property365Components.activeElement = document.activeElement;
    ...
    if (window.chrome) {
        ...
        if (closestFrozenCell) {
           Property365Components[id + 'FZL'] = { cell: closestFrozenCell, left: closestFrozenCell.style.left };
   ...
   Property365Components[id] = function (e) {
        if(e.type == 'contextmenu' || !e.target) return;
        if (!/Android/i.test(navigator.userAgent) && e.type == 'resize') {
          Property365Components.closePopup(id, instance, callback);
            return;
        }
    ...
    if (!Property365Components.closePopupsOnScroll) {
      Property365Components.closePopupsOnScroll = function (e) {
            for (var i = 0; i < Property365Components.popups.length; i++) {
                var p = Property365Components.popups[i];
                Property365Components.closePopup(p.id, p.instance, p.callback);
            }
            Property365Components.popups = [];
        };
        Property365Components.popups = [];
    }

    Property365Components.popups.push({id, instance, callback});

    document.body.appendChild(popup);
    document.removeEventListener('mousedown',Property365Components[id]);
    document.addEventListener('mousedown',Property365Components[id]);
    window.removeEventListener('resize',Property365Components[id]);
    window.addEventListener('resize',Property365Components[id]);

    var p = parent;
    while (p && p != document.body) {
        if (p.scrollWidth > p.clientWidth || p.scrollHeight > p.clientHeight) {
            p.removeEventListener('scroll', Property365Components.closePopupsOnScroll);
            p.addEventListener('scroll', Property365Components.closePopupsOnScroll);
        }
        p = p.parentElement;
    }

    if (!parent) {
        document.removeEventListener('contextmenu',Property365Components[id]);
        document.addEventListener('contextmenu',Property365Components[id]);
    }
  },
  closePopup: function (id, instance, callback) {
    ...
    if (popup) {
      ...
      if (window.chrome &&Property365Components[id + 'FZL']) {
       Property365Components[id + 'FZL'].cell.style.left =Property365Components[id + 'FZL'].left;
       Property365Components[id + 'FZL'] = null;
      }
   ...
   Property365Components[id] = null;
    ...
    if (Property365Components.activeElement && Property365Components.activeElement == document.activeElement || Property365Components.activeElement && document.activeElement == document.body) {
      Property365Components.activeElement.focus();
      Property365Components.activeElement = null;
    }
  },
  togglePopup: function (parent, id, syncWidth, instance, callback) {
    ...
    if (popup.style.display == 'block') {
      ...
      Property365Components.openPopup(parent, id, syncWidth, null, null, null, instance, callback);
    }
  },
  ...
  openDialog: function (options, dialogService) {
    Property365Components.dialogService = dialogService;
    if (
    ...
    if (options.closeDialogOnEsc) {
        document.removeEventListener('keydown', Property365Components.closePopupOrDialog);
        document.addEventListener('keydown', Property365Components.closePopupOrDialog);
    }
  },
  ...
  closePopupOrDialog: function (e) {
      ...
      if (isEscape && Property365Components.dialogService) {
          ...
          Property365Components.dialogService.invokeMethodAsync('DialogService.Close', null);
      }
  },
  ...
  startDrag: function (ref, instance, handler) {
    ...
    ref.mouseUpHandler = function (e) {
      Property365Components.endDrag(ref);
    };
    ...
    return Property365Components.clientRect(ref);
  },
  ...
  startColumnReorder: function(id) {
     ...
     Property365Components[id + 'end'] = function (e) {
          var el = document.getElementById(id + 'visual');
          if (el) {
              document.body.removeChild(el);
             Property365Components[id + 'end'] = null;
             Property365Components[id + 'move'] = null;
          }
      }
      document.removeEventListener('click',Property365Components[id + 'end']);
      document.addEventListener('click',Property365Components[id + 'end']);

     Property365Components[id + 'move'] = function (e) {
          var el = document.getElementById(id + 'visual');
          if (el) {
      ...
      document.removeEventListener('mousemove',Property365Components[id + 'move']);
      document.addEventListener('mousemove',Property365Components[id + 'move']);
  },
  startColumnResize: function(id, grid, columnIndex, clientX) {
     ...
     Property365Components[el] = {
          clientX: clientX,
          width: cell.getBoundingClientRect().width,
          mouseUpHandler: function (e) {
              if (Property365[el]) {
                  grid.invokeMethodAsync(
                      'Property365Grid.OnColumnResized',
                      columnIndex,
                      cell.getBoundingClientRect().width
                  );
                  document.removeEventListener('mousemove',Property365Components[el].mouseMoveHandler);
                  document.removeEventListener('mouseup',Property365Components[el].mouseUpHandler);
                  document.removeEventListener('touchmove',Property365Components[el].touchMoveHandler)
                  document.removeEventListener('touchend',Property365Components[el].mouseUpHandler);
                 Property365Components[el] = null;
              }
          },
          mouseMoveHandler: function (e) {
              if (Property365[el]) {
                  var width = (Property365[el].width - (Property365[el].clientX - e.clientX)) + 'px';
                  if (cell) {
          ...
          touchMoveHandler: function (e) {
              if (e.targetTouches[0]) {
                 Property365Components[el].mouseMoveHandler(e.targetTouches[0]);
              }
          }
      };
      document.addEventListener('mousemove',Property365Components[el].mouseMoveHandler);
      document.addEventListener('mouseup',Property365Components[el].mouseUpHandler);
      document.addEventListener('touchmove',Property365Components[el].touchMoveHandler, { passive: true })
      document.addEventListener('touchend',Property365Components[el].mouseUpHandler, { passive: true });
  },
       ...
       Property365Components[el] = {
            ...
            mouseUpHandler: function(e) {
                if (Property365[el]) {
                    splitter.invokeMethodAsync(
                        'Property365Splitter.OnPaneResized',
            ...
            mouseMoveHandler: function(e) {
                if (Property365[el]) {
                    ...
                    var spacePerc =Property365Components[el].panePerc +Property365Components[el].paneNextPerc;
                    var spaceLength =Property365Components[el].paneLength +Property365Components[el].paneNextLength;

                    var length = (Property365[el].paneLength -
                        (Property365[el].clientPos - (isHOrientation ? e.clientX : e.clientY)));
                    ...
                    var perc = length /Property365Components[el].paneLength;
                    if (!isFinite(perc)) {
                        perc = 1;
                       Property365Components[el].panePerc = 0.1;
                       Property365Components[el].paneLength =isHOrientation
                            ? pane.getBoundingClientRect().width
                            : pane.getBoundingClientRect().height;
                    }
                    
                    var newPerc = Property365Components[el].panePerc * perc;
