...
{
    /// <summary>
    /// Property365Rating component.
    /// </summary>
    /// <example>
    /// <code>
    /// &lt;Property365Rating Stars="10" Change=@(args => Console.WriteLine($"Value: {args}")) /&gt;
    /// </code>
    /// </example>
    public partial class Property365Rating : FormComponent<int>
    {
        /// <inheritdoc />
