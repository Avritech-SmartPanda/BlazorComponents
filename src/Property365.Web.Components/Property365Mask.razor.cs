...
{
    /// <summary>
    /// Property365Mask component.
    /// </summary>
    /// <example>
    /// <code>
    /// &lt;Property365Mask Mask="(***) ***-****" Pattern="[^0-9]" Placeholder="(000) 000-0000" @bind-Value=@phone Change=@(args => Console.WriteLine($"Value: {args}")) /&gt;
    /// </code>
    /// </example>
    public partial class Property365Mask : FormComponent<string>
    {
        /// <summary>
