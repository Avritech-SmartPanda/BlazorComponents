...
{
    /// <summary>
    /// Base class of <see cref="Property365Chart" /> series.
    /// </summary>
    /// <typeparam name="TItem">The type of the series data.</typeparam>
    public abstract class CartesianSeries<TItem> : Property365ChartComponentBase, IChartSeries, IDisposable
    {
        /// <summary>
        ...
        /// <inheritdoc />
        public Property365Markers Markers { get; set; } = new Property365Markers();
