...
namespace Property365.Web.Components
{
    ...
    /// </code>
    /// </example>
    public class Property365TemplateForm<TItem> : Property365Component, IProperty365Form
    {
        /// <summary>
        ...
        /// <example>
        /// <code>
        /// &lt;Property365TemplateForm TItem="Model" Submit=@OnSubmit Data=@model&gt;
        ///   &lt;Property365TextBox style="display: block" Name="Email" @bind-Value=@model.Email /&gt;
        ///   &lt;Property365RequiredValidator Component="Email" Text="Email is required" Style="position: absolute" /&gt;
        /// &lt;/Property365TemplateForm&gt;
        /// @code {
        ...
        /// <example>
        /// <code>
        /// &lt;Property365TemplateForm TItem="Model" InvalidSubmit=@OnInvalidSubmit Data=@model&gt;
        ///   &lt;Property365TextBox style="display: block" Name="Email" @bind-Value=@model.Email /&gt;
        ///   &lt;Property365RequiredValidator Component="Email" Text="Email is required" Style="position: absolute" /&gt;
        /// &lt;/Property365TemplateForm&gt;
        /// @code {
        ...
        /// <example>
        /// <code>
        /// &lt;Property365TemplateForm TItem="Model" Method="post" Action="/register" Data=@model&gt;
        ///   &lt;Property365TextBox style="display: block" Name="Email" @bind-Value=@model.Email /&gt;
        ///   &lt;Property365RequiredValidator Component="Email" Text="Email is required" Style="position: absolute" /&gt;
        /// &lt;/Property365TemplateForm&gt;
        /// </code>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Property365TemplateForm{TItem}"/> class.
        /// </summary>
        public Property365TemplateForm()
        {
