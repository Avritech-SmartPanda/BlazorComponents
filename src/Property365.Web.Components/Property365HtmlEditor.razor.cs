...
namespace Property365.Web.Components
{
    ...
    /// </code>
    /// </example>
    public partial class Property365HtmlEditor : FormComponent<string>
    {
        /// <summary>
        ...
        /// <example>
        /// <code>
        /// &lt;Property365HtmlEditor @bind-Value=@html Paste=@OnPaste /&gt;
        /// @code {
        ///   string html = "@lt;strong&gt;Hello&lt;/strong&gt; world!"; 
        ...
        /// <summary>
        /// Specifies the URL to which Property365HtmlEditor will submit files.
        /// </summary>
        [Parameter]
        ...
        internal Property365HtmlEditorCommandState State { get; set; } = new Property365HtmlEditorCommandState();
        ...
        /// <summary>
        /// Invoked by interop when the Property365HtmlEditor selection changes.
        /// </summary>
        [JSInvokable]
        ...
        {
            State = await JSRuntime.InvokeAsync<Property365HtmlEditorCommandState>("Property365Components.execCommand", ContentEditable, name, value);
        ...
        /// <summary>
        /// Saves the current selection. Property365HtmlEditor will lose its selection when it loses focus. Use this method to persist the current selection.
        /// </summary>
        public async Task SaveSelectionAsync()
        {
            await JSRuntime.InvokeVoidAsync("Property365Components.saveSelection", ContentEditable);
        }
        ...
        {
            await JSRuntime.InvokeVoidAsync("Property365Components.restoreSelection", ContentEditable);
        }

        async Task UpdateCommandState()
        {
            State = await JSRuntime.InvokeAsync<Property365HtmlEditorCommandState>("Property365Components.queryCommands", ContentEditable);
        ...
        protected override async Task OnAfterRenderAsync(bool firstRender)
        {
            ...
            if (firstRender || visibleChanged)
            {
                ...
                if (Visible)
                {
                    await JSRuntime.InvokeVoidAsync("Property365Components.createEditor", ContentEditable, UploadUrl, Paste.HasDelegate, Reference);
                }
            }
            ...
            if (valueChanged)
            {
                ...
                if (Visible)
                {
                    await JSRuntime.InvokeVoidAsync("Property365Components.innerHTML", ContentEditable, Value);
                }
            }
        }
        ...
        /// <summary>
        /// Invoked via interop when the value of Property365HtmlEditor changes.
        /// </summary>
        ...
        /// <summary>
        /// Invoked via interop when the user pastes content in Property365HtmlEditor. Invokes <see cref="Paste" />.
        /// </summary>
        /// <param name="html">The HTML.</param>
        [JSInvokable]
        ...
        public override async Task SetParametersAsync(ParameterView parameters)
        {
            ...
            {
                await JSRuntime.InvokeVoidAsync("Property365Components.destroyEditor", ContentEditable);
            }
        }
        ...
        public override void Dispose()
        {
            ...
            {
                JSRuntime.InvokeVoidAsync("Property365Components.destroyEditor", ContentEditable);
            }
        }
    }
}
