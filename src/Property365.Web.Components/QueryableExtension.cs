...
namespace Property365.Web.Components
{
    ...
    public static class QueryableExtension
    {
        ...
        public static string ToFilterString<T>(this IEnumerable<Property365GridColumn<T>> columns)
        {
            Func<Property365GridColumn<T>, bool> canFilter = (c) => c.Filterable && !string.IsNullOrEmpty(c.Type) &&
        ...
        /// <param name="columns">The columns.</param>
        /// <returns>System.String.</returns>
        public static string ToFilterString<T>(this IEnumerable<Property365DataGridColumn<T>> columns)
        {
            Func<Property365DataGridColumn<T>, bool> canFilter = (c) => c.Filterable && c.FilterPropertyType != null &&
        ...
        /// <returns>System.String.</returns>
        private static string GetColumnFilter<T>(Property365GridColumn<T> column, bool second = false)
        {
            var property = PropertyAccess.GetProperty(column.GetFilterProperty());
        ...
        /// <param name="second">if set to <c>true</c> [second].</param>
        /// <returns>System.String.</returns>
        private static string GetColumnFilter<T>(Property365DataGridColumn<T> column, string value, bool second = false)
        {
            var property = PropertyAccess.GetProperty(column.GetFilterProperty());
        ...
        /// <param name="second">if set to <c>true</c> [second].</param>
        /// <returns>System.String.</returns>
        private static string GetColumnODataFilter<T>(Property365GridColumn<T> column, bool second = false)
        {
            var columnType = column.Type;
            var columnFormat = column.Format;
        ...
        /// <param name="second">if set to <c>true</c> [second].</param>
        /// <returns>System.String.</returns>
        private static string GetColumnODataFilter<T>(Property365DataGridColumn<T> column, bool second = false)
        {
            var property = column.GetFilterProperty().Replace('.', '/');
        ...
        /// <param name="columns">The columns.</param>
        /// <returns>System.String.</returns>
        public static string ToODataFilterString<T>(this IEnumerable<Property365GridColumn<T>> columns)
        {
            Func<Property365GridColumn<T>, bool> canFilter = (c) => c.Filterable && !string.IsNullOrEmpty(c.Type) &&
                !(c.FilterValue == null || c.FilterValue as string == string.Empty) && c.GetFilterProperty() != null;
        ...
        /// <param name="columns">The columns.</param>
        /// <returns>System.String.</returns>
        public static string ToODataFilterString<T>(this IEnumerable<Property365DataGridColumn<T>> columns)
        {
            Func<Property365DataGridColumn<T>, bool> canFilter = (c) => c.Filterable && c.FilterPropertyType != null &&
                (!(c.GetFilterValue() == null || c.GetFilterValue() as string == string.Empty) || c.GetFilterOperator() == FilterOperator.IsNotNull || c.GetFilterOperator() == FilterOperator.IsNull)
                    && c.GetFilterProperty() != null;
        ...
        public static IQueryable<T> Where<T>(this IQueryable<T> source, IEnumerable<Property365GridColumn<T>> columns)
        {
            Func<Property365GridColumn<T>, bool> canFilter = (c) => c.Filterable && !string.IsNullOrEmpty(c.Type) &&
                !(c.FilterValue == null || c.FilterValue as string == string.Empty) && c.GetFilterProperty() != null;
        ...
        /// <param name="columns">The columns.</param>
        /// <returns>IQueryable&lt;T&gt;.</returns>
        public static IQueryable<T> Where<T>(this IQueryable<T> source, IEnumerable<Property365DataGridColumn<T>> columns)
        {
            Func<Property365DataGridColumn<T>, bool> canFilter = (c) => c.Filterable && c.FilterPropertyType != null &&
                (!(c.GetFilterValue() == null || c.GetFilterValue() as string == string.Empty) || c.GetFilterOperator() == FilterOperator.IsNotNull || c.GetFilterOperator() == FilterOperator.IsNull)
                    && c.GetFilterProperty() != null;
