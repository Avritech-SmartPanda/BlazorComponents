...
namespace Property365.Web.Components
{
    ...
    /// </code>
    /// </example>
    public partial class Property365Scheduler<TItem> : Property365Component, IScheduler
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets the data of Property365Scheduler. It will display an appointment for every item of the collection which is within the current view date range.
        /// </summary>
        ...
        /// <example>
        /// <code>
        /// &lt;Property365Scheduler Data=@appointments SlotSelect=@OnSlotSelect&gt;
        /// &lt;/Property365Scheduler&gt;
        /// @code {
        ...
        /// <example>
        /// <code>
        /// &lt;Property365Scheduler Data=@appointments AppointmentSelect=@OnAppointmentSelect&gt;
        /// &lt;/Property365Scheduler&gt;
        /// @code {
        ...
        /// <example>
        /// <code>
        /// &lt;Property365Scheduler Data=@appointments AppointmentRender=@OnAppointmentRendert&gt;
        /// &lt;/Property365Scheduler&gt;
        /// @code {
        ...
        /// <example>
        /// <code>
        /// &lt;Property365Scheduler Data=@appointments SlotRender=@OnSlotRender&gt;
        /// &lt;/Property365Scheduler&gt;
        /// @code {
        ...
        protected override async Task OnAfterRenderAsync(bool firstRender)
        {
            ...
            if (firstRender)
            {
                var rect = await JSRuntime.InvokeAsync<Rect>("Property365.Web.Components.createScheduler", Element, Reference);
        ...
        public override void Dispose()
        {
            ...
            {
                JSRuntime.InvokeVoidAsync("Property365Components.destroyScheduler", Element);
            }
        }
