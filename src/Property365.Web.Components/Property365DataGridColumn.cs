...
{
    /// <summary>
    /// Property365DataGridColumn component.
    /// Must be placed inside a <see cref="Property365DataGrid{TItem}" />
    /// </summary>
    /// <typeparam name="TItem">The type of the DataGrid item.</typeparam>
    public partial class Property365DataGridColumn<TItem> : ComponentBase, IDisposable
    {
        /// <summary>
        ...
        [CascadingParameter]
        public Property365DataGrid<TItem> Grid { get; set; }
        ...
        [CascadingParameter]
        public Property365DataGridColumn<TItem> Parent { get; set; }
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="Property365DataGridColumn{TItem}"/> is visible.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="Property365DataGridColumn{TItem}"/> is filterable.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="Property365DataGridColumn{TItem}"/> is sortable.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="Property365DataGridColumn{TItem}"/> is frozen.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="Property365DataGridColumn{TItem}"/> is resizable.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="Property365DataGridColumn{TItem}"/> is reorderable.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="Property365DataGridColumn{TItem}"/> is groupable.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="Property365DataGridColumn{TItem}"/> is pickable - listed when DataGrid AllowColumnPicking is set to true.
        /// </summary>
        ...
        [Parameter]
        public RenderFragment<Property365DataGridColumn<TItem>> FilterTemplate { get; set; }
        ...
        internal string GetSortOrderAsString(bool isOData)
        {
            ...
            return $"{p} {(GetSortOrder() == Components.SortOrder.Ascending ? "asc" : "desc")}";
        }
        ...
        {
            await Grid.GetJSRuntime().InvokeVoidAsync("Property365Components.closePopup", $"{Grid.PopupID}{GetFilterProperty()}");
        }
