...
{
    /// <summary>
    /// Property365Login component. Must be placed in Property365TemplateForm.
    /// </summary>
    /// <example>
    /// <code>
    /// &lt;Property365TemplateForm Data=@("Login")&gt;
    ...
    /// </code>
    /// </example>
    public partial class Property365Login : Property365Component
    {
        /// <summary>
        ...
        protected async Task OnLogin()
        {
            ...
            {
                await Login.InvokeAsync(new LoginArgs { Username = Username, Password = Password });
            }
        }
