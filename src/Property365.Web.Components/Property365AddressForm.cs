...
namespace Property365.Web.Components
{
    ...
    /// <example>
    /// <code>
    /// &lt;Property365AddressForm TItem="Model" Data=@model&gt;
    ...
    /// </code>
    /// </example>
    public class Property365AddressForm<TItem> : Property365Component, IProperty365Form
    {
        /// <summary>
        ...
        /// <example>
        /// <code>
        /// &lt;Property365AddressForm TItem="Model" OnValidSubmit=@OnSubmit Data=@model&gt;
        ///   &lt;Property365TextBox style="display: block" Name="Email" @bind-Value=@model.Email /&gt;
        ///   &lt;Property365RequiredValidator Component="Email" Text="Email is required" Style="position: absolute" /&gt;
        /// &lt;/Property365AddressForm&gt;
        /// @code {
        ...
        /// <example>
        /// <code>
        /// &lt;Property365AddressForm TItem="Model" InvalidSubmit=@OnInvalidSubmit Data=@model&gt;
        ///   &lt;Property365TextBox style="display: block" Name="Email" @bind-Value=@model.Email /&gt;
        ///   &lt;Property365RequiredValidator Component="Email" Text="Email is required" Style="position: absolute" /&gt;
        /// &lt;/Property365AddressForm&gt;
        /// @code {
        ...
        /// <example>
        /// <code>
        /// &lt;Property365AddressForm TItem="Model" Method="post" Action="/register" Data=@model&gt;
        ///   &lt;Property365TextBox style="display: block" Name="Email" @bind-Value=@model.Email /&gt;
        ///   &lt;Property365RequiredValidator Component="Email" Text="Email is required" Style="position: absolute" /&gt;
        /// &lt;/Property365AddressForm&gt;
        /// </code>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Property365AddressForm{TItem}"/> class.
        /// </summary>
        public Property365AddressForm()
        {
