...
{
    /// <summary>
    /// Class Property365Legend.
    /// </summary>
    public class Property365Legend : Property365ChartComponentBase
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="Property365Legend"/> is visible.
        /// </summary>
        /// <value><c>true</c> if visible; otherwise, <c>false</c>.</value>
        [Parameter]
        public bool Visible { get; set; } = true;

        internal double Measure(Property365Chart chart)
        {
            if (!Visible)
            {
                return 0;
