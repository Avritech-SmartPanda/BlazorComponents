...
{
    /// <summary>
    /// Property365FileInput component.
    /// </summary>
    /// <typeparam name="TValue">The type of the value.</typeparam>
    /// <example>
    /// <code>
    /// &lt;Property365FileInput @bind-Value=@employee.Photo TValue="string" Change=@(args => Console.WriteLine($"File content as base64 string: {args}")) /&gt;
    /// </code>
    /// </example>
    public partial class Property365FileInput<TValue> : FormComponent<TValue>
    {
        ...
        async Task OnChange()
        {
            ...
            try
            {
                uploadValue = await JSRuntime.InvokeAsync<string>("Property365Components.readFileAsBase64", fileUpload, MaxFileSize, MaxWidth, MaxHeight);
