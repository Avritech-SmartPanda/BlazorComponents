...
{
    /// <summary>
    /// Property365Stepper component.
    /// </summary>
    /// <example>
    /// <code>
    /// &lt;Property365Stepper Change=@(args => Console.WriteLine($"Selected index is: {args}"))&gt;
    ///     &lt;Steps&gt;
    ///         &lt;Property365StepperItem Text="Orders"&gt;
    ///             Details for Orders
    ///         &lt;/Property365StepperItem&gt;
    ///         &lt;Property365StepperItem Text="Employees"&gt;
    ...
    /// </code>
    /// </example>
    public partial class Property365Stepper : Property365Component
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether to show progress bar and header.
        /// </summary>
        /// <value><c>true</c> if steps labels are shown; otherwise, <c>false</c>.</value>
        [Parameter]
        public bool ShowStepsHeader { get; set; } = true;
        ...
        public IList<Property365StepperItem> StepsCollection
        {
            get
            {
                return steps;
        ...
        /// <summary>
        /// Gets or sets an id to the form to raise the save event.
        /// </summary>
        ...
        List<Property365StepperItem> steps = new List<Property365StepperItem>();

        /// <summary>
        /// Adds the step.
        /// </summary>
        /// <param name="step">The step.</param>
        public void AddStep(Property365StepperItem step)
        {
        ...
        public void RemoveStep(Property365StepperItem item)
        {
        ...
        protected bool IsSelected(int index, Property365StepperItem step)
        {
            return SelectedIndex == index;
        }

        internal async System.Threading.Tasks.Task SelectStep(Property365StepperItem step, bool raiseChange = false)
        {
            var valid = true;
