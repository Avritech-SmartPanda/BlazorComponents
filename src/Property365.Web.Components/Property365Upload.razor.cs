...
namespace Property365.Web.Components
{
   /// <summary>
    ...
    /// </code>
    /// </example>
    public partial class Property365Upload : Property365Component
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="Property365Upload"/> upload is automatic.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="Property365Upload"/> is multiple.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="Property365Upload"/> is disabled.
        /// </summary>
        ...
        {
            await JSRuntime.InvokeAsync<string>("Property365Components.upload", fileUpload, Url, Multiple, false, ParameterName);
        }
        ...
        protected override async Task OnAfterRenderAsync(bool firstRender)
        {
            ...
            if (firstRender || visibleChanged)
            {
                ...
                if (Visible)
                {
                    await JSRuntime.InvokeVoidAsync("Property365Components.uploads", Reference, Id);
                }
            }
        }
        ...
        {
            files.Remove(file);
            await JSRuntime.InvokeVoidAsync("Property365Components.removeFileFromUpload", fileUpload, file.Name);
            await Change.InvokeAsync(new UploadChangeEventArgs() { Files = files.Select(f => new FileInfo() { Name = f.Name, Size = f.Size }).ToList() });
        }
        ...
        [JSInvokable("Property365Upload.OnChange")]
        ...
        [JSInvokable("Property365Upload.OnProgress")]
        ...
        [JSInvokable("Property365Upload.OnComplete")]
        ...
        [JSInvokable("Property365Upload.OnError")]
