...
{
    /// <summary>
    /// A component which is an item in a <see cref="Property365Tree" />
    /// </summary>
    public partial class Property365TreeItem : IDisposable
    {
        ...
        /// </summary>
        [CascadingParameter]
        public Property365Tree Tree { get; set; }

        /// <summary>
        /// The Property365TreeItem which contains this item.
        /// </summary>
        [CascadingParameter]
        public Property365TreeItem ParentItem { get; set; }
        ...
        internal bool Contains(Property365TreeItem child)
        {
