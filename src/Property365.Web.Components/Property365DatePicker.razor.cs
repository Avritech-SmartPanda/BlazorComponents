...
{
    /// <summary>
    /// Property365DatePicker component.
    /// </summary>
    /// <typeparam name="TValue">The type of the t value.</typeparam>
    /// <example>
    /// <code>
    /// &lt;Property365DatePicker @bind-Value=@someValue TValue="DateTime" Change=@(args => Console.WriteLine($"Selected date: {args}")) /&gt;
    /// </code>
    /// </example>
    public partial class Property365DatePicker<TValue> : Property365Component, IProperty365FormComponent
    {
        Property365DropDown<int> monthDropDown;
        Property365DropDown<int> yearDropDown;
        ...
        protected async Task ParseDate()
        {
            DateTime? newValue;
            DateTime value;
            var inputValue = await JSRuntime.InvokeAsync<string>("Property365Components.getInputValue", input);
            ...
            else
            {
                ...
                if (nullable)
                {
                    await JSRuntime.InvokeAsync<string>("Property365Components.setInputValue", input, "");
                }
                else
                {
                    await JSRuntime.InvokeAsync<string>("Property365Components.setInputValue", input, FormattedValue);
                }
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="Property365DatePicker{TValue}"/> is inline - only Calender.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="Property365DatePicker{TValue}"/> is disabled.
        /// </summary>
        ...
        {
            return !Disabled && !ReadOnly && !Inline ? $"Property365Components.togglePopup(this.parentNode, '{PopupID}')" : "";
        }

        private string getOpenPopupForInput()
        {
            return !Disabled && !ReadOnly && !Inline && !AllowInput ? $"Property365Components.togglePopup(this.parentNode, '{PopupID}')" : "";
        }
