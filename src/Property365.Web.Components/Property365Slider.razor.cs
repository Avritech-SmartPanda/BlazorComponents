...
{
    /// <summary>
    /// Property365Slider component.
    /// </summary>
    /// <typeparam name="TValue">The type of the value.</typeparam>
    /// <example>
    /// <code>
    /// &lt;Property365Slider @bind-Value=@value TValue="int" Min="0" Max="100" Change=@(args => Console.WriteLine($"Value: {args}")) /&gt;
    /// </code>
    /// </example>
    public partial class Property365Slider<TValue> : FormComponent<TValue>
    {
        ...
        protected override async Task OnAfterRenderAsync(bool firstRender)
        {
            ...
            if (firstRender || visibleChanged || disabledChanged || maxChanged || minChanged || rangeChanged || stepChanged)
            {
                ...
                if (Visible && !Disabled)
                {
                    await JSRuntime.InvokeVoidAsync("Property365Components.createSlider", UniqueID, Reference, Element, Range, Range ? minHandle : handle, maxHandle, Min, Max, Value, Step);
        ...
        public override void Dispose()
        {
            ...
            {
                JSRuntime.InvokeVoidAsync("Property365Components.destroySlider", UniqueID, Element);
            }
        }
        ...
        [JSInvokable("Property365Slider.OnValueChange")]
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="Property365Slider{TValue}"/> is range.
        /// </summary>
