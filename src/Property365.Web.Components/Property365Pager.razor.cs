...
{
    /// <summary>
    /// Property365Pager component.
    /// </summary>
    /// <example>
    /// <code>
    /// &lt;Property365Pager Count="100" PageSize="10" PageNumbersCount="5" PageChanged=@(args => Console.WriteLine($"Skip: {args.Skip}, Top: {args.Top}")) /&gt;
    /// </code>
    /// </example>
    public partial class Property365Pager : Property365Component
    {
