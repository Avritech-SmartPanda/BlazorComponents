...
{
    /// <summary>
    /// Property365ColorPicker component.
    /// </summary>
    /// <example>
    /// <code>
    /// &lt;Property365ColorPicker @bind-Value=@color Change=@(args => Console.WriteLine($"Selected color: {args}")) /&gt;
    /// </code>
    /// </example>
    public partial class Property365ColorPicker : FormComponent<string>
    {
        /// <summary>
