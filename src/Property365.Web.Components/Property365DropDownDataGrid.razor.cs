...
{
    /// <summary>
    /// Property365DropDownDataGrid component.
    /// </summary>
    /// <typeparam name="TValue">The type of the t value.</typeparam>
    /// <example>
    /// <code>
    /// &lt;Property365DropDownDataGrid @bind-Value=@customerID TValue="string" Data=@customers TextProperty="CompanyName" ValueProperty="CustomerID" Change=@(args => Console.WriteLine($"Selected CustomerID: {args}")) /&gt;
    /// </code>
    /// </example>
    public partial class Property365DropDownDataGrid<TValue> : DropDownBase<TValue>
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="Property365DropDownDataGrid{TValue}"/> is responsive.
        /// </summary>
        ...
        Property365DataGrid<object> grid;
        ...
        protected override Task OnAfterRenderAsync(bool firstRender)
        {
            if (firstRender)
            {
                ...
                {
                    LoadData.InvokeAsync(new LoadDataArgs() { Skip = 0, Top = PageSize });
                }
        ...
        protected override async Task OnDataChanged()
        {
            ...
            {
                searchText = null;
                await OnLoadData(new LoadDataArgs() { Skip = 0, Top = PageSize });
            }
        }
        ...
        private bool IsColumnFilterPropertyTypeString(Property365DataGridColumn<object> column)
        {
        ...
        async Task OnLoadData(LoadDataArgs args)
        {
            ...
            {
                await LoadData.InvokeAsync(new LoadDataArgs() { Skip = args.Skip, Top = args.Top, OrderBy = args.OrderBy, Filter = searchText });
            }
        }
        ...
        {
            return GetClassList("dropdown").Add("rz-clear", AllowClear).ToString();
        }
