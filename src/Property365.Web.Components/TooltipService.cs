...
namespace Property365.Web.Components
{
    ...
    /// Should be added as scoped service in the application services and Property365Tooltip should be added in application main layout.
    ...
    /// &lt;Property365Button Text="Show tooltip" MouseEnter="@(args =&gt; ShowTooltipWithHtml(args, new TooltipOptions(){ Style = "color:#000", Duration = null }))" /&gt;
    /// @code {
