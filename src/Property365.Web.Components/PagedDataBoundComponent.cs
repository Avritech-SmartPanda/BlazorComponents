...
namespace Property365.Web.Components
{
    ...
    public class PagedDataBoundComponent<T> : Property365Component
    {
        /// <summary>
        ...
        public async virtual Task Reload()
        {
            ...
            await LoadData.InvokeAsync(new Property365.Web.Components.LoadDataArgs() { Skip = skip, Top = PageSize });
        ...
        /// The top pager
        /// </summary>
        protected Property365Pager topPager;
        /// <summary>
        /// The bottom pager
        /// </summary>
        protected Property365Pager bottomPager;
