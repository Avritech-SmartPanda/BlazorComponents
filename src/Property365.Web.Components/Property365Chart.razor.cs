...
namespace Property365.Web.Components
{
    ...
    /// </code>
    /// </example>
    public partial class Property365Chart : Property365Component
    {
        /// <summary>
        ...
        internal Property365ColumnOptions ColumnOptions { get; set; } = new Property365ColumnOptions();
        internal Property365BarOptions BarOptions { get; set; } = new Property365BarOptions();
        internal Property365Legend Legend { get; set; } = new Property365Legend();
        internal Property365CategoryAxis CategoryAxis { get; set; } = new Property365CategoryAxis();
        internal Property365ValueAxis ValueAxis { get; set; } = new Property365ValueAxis();
        internal Property365ChartTooltipOptions Tooltip { get; set; } = new Property365ChartTooltipOptions();
        ...
        {
            var pieType = typeof(Property365PieSeries<>);
            var donutType = typeof(Property365DonutSeries<>);
        ...
        /// <summary>
        /// Invoked via interop when the Property365Chart resizes. Display the series with the new dimensions.
        /// </summary>
        ...
        /// <summary>
        /// Invoked via interop when the user moves the mouse over the Property365Chart. Displays the tooltip.
        /// </summary>
        ...
        /// <summary>
        /// Invoked via interop when the user clicks the Property365Chart. Raises the <see cref="SeriesClick" /> handler.
        /// </summary>
        /// <param name="x">The x.</param>
        /// <param name="y">The y.</param>
        [JSInvokable]
        ...
        protected override async Task OnAfterRenderAsync(bool firstRender)
        {
            ...
            if (firstRender || visibleChanged)
            {
                ...
                if (Visible)
                {
                    var rect = await JSRuntime.InvokeAsync<Rect>("Property365Components.createChart", Element, Reference);
        ...
        public override async Task SetParametersAsync(ParameterView parameters)
        {
            ...
            if (visibleChanged && !firstRender)
            {
                if (Visible == false)
                {
                    await JSRuntime.InvokeVoidAsync("Property365Components.destroyChart", Element);
                }
            }
        }
        ...
        public override void Dispose()
        {
            ...
            {
                JSRuntime.InvokeVoidAsync("Property365Components.destroyChart", Element);
            }
        }
